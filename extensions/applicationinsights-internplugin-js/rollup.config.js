...
const outputName = "applicationinsights-internplugin-js";
const banner = [
  "/*!",
...
const browserRollupConfigFactory = isProduction => {
  const browserRollupConfig = {
    ...
    output: {
      ...
      banner: banner,
      format: "umd",
      name: "Microsoft.ApplicationInsights.InternPlugin",
      sourcemap: true
    },
    plugins: [
      replace({
      ...
      importCheck({ exclude: [ "applicationinsights-internplugin-js" ] }),
      nodeResolve({
        browser: false,
