const myFunc = () => {
  ...
  const internPluginInstance = new Microsoft.ApplicationInsights.InternPlugin.InternPlugin();
  window.internPluginInstance = internPluginInstance;
  ...
  cfg: { // Application Insights Configuration
      ...
      // ],
      extensions: [
        internPluginInstance
      ],
      correlationHeaderDomains: ["oskarsvc", "localhost"],
  }});

  const testBtn = document.createElement('button');
  testBtn.textContent = 'trigger event telemetry';
  testBtn.onclick = () => {
    window.appInsights.trackEvent({name: 'test event'});
  }
